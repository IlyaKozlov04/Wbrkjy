    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="sec-6d07">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          <form action="авторизация.php" method="POST"  style="padding: 15px" source="email">
            <div class="u-form-group u-form-name u-label-top">
              <label for="name-558c" class="u-label">Логин</label>
              <input type="text" placeholder="Логин" id="name-558c" name="login" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
            </div>
