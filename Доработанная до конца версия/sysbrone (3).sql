...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 04 2022 г., 17:27
...
INSERT INTO `oplata` (`ID_Cheta`, `ID_Lager`, `NomerCheta`, `BIK`, `PolnNaimBanka`, `KorrespondChet`, `INN`, `KPP`) VALUES
(1, 1, '12345678912345678912', '123123123', 'sber', '12345678912345678912', '1231231231', '12345678912345678912');
...
(2, 'Название: \"Герои\"', 'Палаточный туристический лагерь', 'Можайск, Московская область, Россия', 'Круглосуточный', 'Только летние', '+7-234-434-89-90'),
(3, 'Название: \"Я - Лидер Сочи!\"', 'Палаточный военно-патриотический лагерь', 'Пансионат-отель \"Кристалл\", г. Сочи, ул. Эпроновская, 1', 'Круглосуточный', 'Только летние', '+7-553-284-67-24');
...
INSERT INTO `smeni` (`ID_Smeni`, `ID_Lager`, `NazvCmeni`, `DataNachalo`, `DataConec`, `Price`) VALUES
(1, 1, 'Смена \"Солнышки\"', '2022-11-01', '2022-11-07', 9500),
(2, 2, 'Смена \"Солдатики\"', '2022-08-01', '2022-08-14', 19000),
(3, 3, 'Смена \"Цветочки\"', '2022-07-01', '2022-07-07', 11000);
...
--
ALTER TABLE `smeni`
  MODIFY `ID_Smeni` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
