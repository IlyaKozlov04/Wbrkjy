...
<php style="font-size: 16px;" lang="ru"><head>
    ...
    <title>Авторизация для родителя</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Авторизация-для-родителя.css" media="screen">
    ...
    <meta property="og:title" content="Авторизация для родителя">
  ...
  <body class="u-body u-xl-mode" data-lang="ru"><header class="u-clearfix u-gradient u-header u-sticky u-header" id="sec-074a"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="sec-6d07">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px" source="email" redirect="true" redirect-address="Кабинет-для-родителя.php">
            <div class="u-form-group u-form-name u-label-top">
              <label for="name-558c" class="u-label">Логин</label>
              <input type="text" placeholder="Логин" id="name-558c" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-label-top">
              <label for="email-558c" class="u-label">Пароль</label>
              <input type="text" placeholder="Пароль" id="email-558c" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required">
            </div>
            <div class="u-form-group u-form-submit u-label-top">
              <a href="Кабинет-для-родителя.php" class="u-border-none u-btn u-btn-submit u-button-style u-palette-2-base u-btn-1">Войти как родитель</a>
              <input type="submit" value="submit" class="u-form-control-hidden">
            </div>
            <div class="u-form-send-message u-form-send-success">Поздравляем, вы вошли!</div>
            <div class="u-form-send-error u-form-send-message">Повторите попытку</div>
            <input type="hidden" value="" name="recaptchaResponse">
            <input type="hidden" name="formServices" value="e5a62908410ebc25578e400f622365b0">
          </form>
        </div>
        <img class="u-image u-image-contain u-image-default u-image-1" src="images/96391ea8-5bf8-a1c1-1422-54df54254073.png" alt="" data-image-width="1280" data-image-height="853">
      </div>
    </section>
